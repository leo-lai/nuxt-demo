<template>
	<div class="l-page-bd">
		<div class="l-page-banner" style="background-image:url('https://static.ushiyihao.com/web/aboutus_banner.jpg')">
			<img src="https://static.ushiyihao.com/web/aboutus_banner.jpg" alt="">
		</div>
  	<div class="_inner">
  		<div class="l-bd-tab">
  			<div class="_tit">
  			...
  			<div class="_cont">
  				...
  				<div class="_item" :class="{'_active': tabIndex == 2}">
  					<ul class="l-team-list">
  						...
  						<li>
  							<img class="_avatar" src="https://static.ushiyihao.com/web/cheng.jpg" alt="">
  						...
  						<li>
  							<img class="_avatar" src="https://static.ushiyihao.com/web/xie.jpg" alt="">
  							<p><span class="l-text-gray l-margin-r-s">市场二部运营总监</span><span class="l-fs-xl">谢卓明</span></p>
  							<p>广东海洋大学。</p>
  							<p>大处着眼，小处着手，快消品行业多年实战运营经验。</p>
  						</li>
  						<li>
  							<img class="_avatar" src="https://static.ushiyihao.com/web/kong.jpg" alt="">
